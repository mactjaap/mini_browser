...
def phase5_basic_page_info(badge):
    ...
    return [
        ...
        "HTTP status, size and object counts were retained; Content-Type may be unavailable in BadgeVMS libcurl",
...
def phase5_redirect_info(badge):
    ...
    return [
        "Redirect followed successfully (verified by different requested/final URLs)",
