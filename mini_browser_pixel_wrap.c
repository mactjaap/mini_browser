...
static const unicode_font_range_t g_unicode_ranges[] = {
    { 0x00A0, 0x00FF,      384 }, /* Latin-1 Supplement */
    { 0x0100, 0x017F,     3456 }, /* Latin Extended-A */
    { 0x0180, 0x024F,     7552 }, /* Latin Extended-B */
    { 0x0250, 0x02AF,    14208 }, /* IPA Extensions */
    { 0x02B0, 0x02FF,    17280 }, /* Spacing Modifier Letters */
    { 0x0300, 0x036F,    19840 }, /* Combining Diacritical Marks */
    { 0x0370, 0x03FF,    23424 }, /* Greek and Coptic */
    { 0x0400, 0x04FF,    28032 }, /* Cyrillic */
    { 0x0500, 0x052F,    36224 }, /* Cyrillic Supplement */
    { 0x0530, 0x058F,    37760 }, /* Armenian */
    { 0x10A0, 0x10FF,    40832 }, /* Georgian */
    { 0x1E00, 0x1EFF,    43904 }, /* Latin Extended Additional */
    { 0x1F00, 0x1FFF,    52096 }, /* Greek Extended */
    { 0x2000, 0x206F,    60288 }, /* General Punctuation */
    { 0x2070, 0x209F,    63872 }, /* Superscripts and Subscripts */
    { 0x20A0, 0x20CF,    65408 }, /* Currency Symbols */
    { 0x2100, 0x214F,    66944 }, /* Letterlike Symbols */
    { 0x2150, 0x218F,    69504 }, /* Number Forms */
    { 0x2190, 0x21FF,    71552 }, /* Arrows */
    { 0x2200, 0x22FF,    75136 }, /* Mathematical Operators */
    { 0x2300, 0x23FF,    83328 }, /* Miscellaneous Technical */
    { 0x2500, 0x257F,    91520 }, /* Box Drawing */
    { 0x2580, 0x259F,    95616 }, /* Block Elements */
    { 0x25A0, 0x25FF,    96640 }, /* Geometric Shapes */
    { 0x2600, 0x26FF,    99712 }, /* Miscellaneous Symbols */
    { 0x2700, 0x27BF,   107904 }, /* Dingbats */
    { 0x3000, 0x303F,   114048 }, /* CJK Symbols and Punctuation */
    { 0x3040, 0x309F,   116096 }, /* Hiragana */
    { 0x30A0, 0x30FF,   119168 }, /* Katakana */
    { 0x4E00, 0x9FFF,   122240 }, /* CJK Unified Ideographs */
    { 0xFF00, 0xFFEF,   793984 }, /* Halfwidth and Fullwidth Forms */
};
